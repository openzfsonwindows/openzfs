...
extern size_t strlcpy(register char *s, register const char *t, register size_t n);

extern size_t strlcat(register char *s, register const char *t, register size_t n);
