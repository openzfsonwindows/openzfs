 ...
 */
typedef ASMABI void	(*aes_generate_f)(aes_key_t *, const uint32_t *, int);
typedef ASMABI void	(*aes_encrypt_f)(const uint32_t[], int,
    const uint32_t[4], uint32_t[4]);
typedef ASMABI void	(*aes_decrypt_f)(const uint32_t[], int,
    const uint32_t[4], uint32_t[4]);
