...
Source: "{#Root}\out\build\x64-Debug\cmd\os\windows\zfs_vss_provider\zfs_vss_install.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Filename: "{app}\zfs_vss_install.exe"; Parameters: "/install ""{app}\zfs_vss_provider.exe"""; StatusMsg: "Registering VSS Provider..."; Flags: runhidden waituntilterminated
...
Filename: "{app}\zfs_vss_install.exe"; Parameters: "/uninstall"; RunOnceId: "vssinst"; Flags: runhidden waituntilterminated
; Kernel
