...
#define	ACE_ALL_PERMS   (ACE_READ_DATA|ACE_LIST_DIRECTORY|ACE_WRITE_DATA| \
		...
		ACE_READ_NAMED_ATTRS|ACE_WRITE_NAMED_ATTRS|ACE_EXECUTE| \
		ACE_DELETE_CHILD|ACE_READ_ATTRIBUTES|ACE_WRITE_ATTRIBUTES| \
		ACE_DELETE|ACE_READ_ACL|ACE_WRITE_ACL|ACE_WRITE_OWNER| \
		ACE_SYNCHRONIZE)
