...
#define	VM_NODEBUG		0x00000010	/* matches KM_NODEBUG */
#define	VM_NO_VBA		0x00000020	/* do not descend to bucket */
#define	VM_KMFLAGS		0x000000ff	/* flags to match KM_* flags */
...
/* keep span creation time, newest spans to front */
#define	VMC_TIMEFREE	0x01000000

/* must accompany VMC_TIMEFREE, oldest spans to front */
#define	VMC_OLDFIRST	0x02000000
/*
