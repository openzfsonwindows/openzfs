...
#define	MSFC_HBAPortStatisticsGuid \
	{ 0x3ce7904f, 0x459f, 0x480d, \
	{ 0x9a, 0x3c, 0x01, 0x3e, 0xde, 0x3b, 0xdd, 0xe8 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSFC_HBAPortStatistics_GUID, \
    0x3ce7904f, 0x459f, 0x480d, 0x9a, 0x3c, 0x01, 0x3e, 0xde, 0x3b, \
    0xdd, 0xe8);
#endif
...
#define	MSFC_HBAPortStatistics_PrimitiveSeqProtocolErrCount_SIZE \
	sizeof (LONGLONG)
...
#define	MSFC_HBAPortStatistics_SIZE (FIELD_OFFSET(MSFC_HBAPortStatistics, \
	InvalidCRCCount) + MSFC_HBAPortStatistics_InvalidCRCCount_SIZE)

// HBAFC3MgmtInfo - HBAFC3MgmtInfo
#define	HBAFC3MgmtInfoGuid \
	{ 0x5966a24f, 0x6aa5, 0x418e, \
	{ 0xb7, 0x5c, 0x2f, 0x21, 0x4d, 0xfb, 0x4b, 0x18 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(HBAFC3MgmtInfo_GUID, \
    0x5966a24f, 0x6aa5, 0x418e, 0xb7, 0x5c, 0x2f, 0x21,
    0x4d, 0xfb, 0x4b, 0x18);
#endif
...
#define	HBAFC3MgmtInfo_SIZE (FIELD_OFFSET(HBAFC3MgmtInfo, reserved1) + \
    HBAFC3MgmtInfo_reserved1_SIZE)

// HBAScsiID - HBAScsiID
#define	HBAScsiIDGuid \
	{ 0xa76f5058, 0xb1f0, 0x4622, \
	{ 0x9e, 0x88, 0x5c, 0xc4, 0x1e, 0x34, 0x45, 0x4a } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(HBAScsiID_GUID, \
    0xa76f5058, 0xb1f0, 0x4622, 0x9e, 0x88, 0x5c, 0xc4, \
    0x1e, 0x34, 0x45, 0x4a);
#endif
...
#define	HBAScsiID_SIZE \
	(FIELD_OFFSET(HBAScsiID, OSDeviceName) + HBAScsiID_OSDeviceName_SIZE)
...
#define	MSFC_LinkEventGuid \
	{ 0xc66015ee, 0x014b, 0x498a, \
	{ 0x94, 0x51, 0x99, 0xfe, 0xad, 0x0a, 0xb4, 0x51 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSFC_LinkEvent_GUID, \
    0xc66015ee, 0x014b, 0x498a, 0x94, 0x51, 0x99, 0xfe, \
    0xad, 0x0a, 0xb4, 0x51);
#endif
...
#define	MSFC_FCAdapterHBAAttributesGuid \
	{ 0xf8f3ea26, 0xab2c, 0x4593, \
	{ 0x8b, 0x84, 0xc5, 0x64, 0x28, 0xe6, 0xbe, 0xdb } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSFC_FCAdapterHBAAttributes_GUID, \
    0xf8f3ea26, 0xab2c, 0x4593, 0x8b, 0x84, 0xc5, 0x64,\
    0x28, 0xe6, 0xbe, 0xdb);
#endif
...
#define	MSFC_HBAPortAttributesResultsGuid \
	{ 0xa76bd4e3, 0x9961, 0x4d9b, \
	{ 0xb6, 0xbe, 0x86, 0xe6, 0x98, 0x26, 0x0f, 0x68 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSFC_HBAPortAttributesResults_GUID, \
    0xa76bd4e3, 0x9961, 0x4d9b, 0xb6, 0xbe, 0x86, 0xe6,\
    0x98, 0x26, 0x0f, 0x68);
#endif
...
#define	MSFC_HBAPortAttributesResults_PortSupportedClassofService_SIZE \
	sizeof (ULONG)
#define	MSFC_HBAPortAttributesResults_PortSupportedClassofService_ID 6

	//
	UCHAR PortSupportedFc4Types[32];
#define	MSFC_HBAPortAttributesResults_PortSupportedFc4Types_SIZE \
	sizeof (UCHAR[32])
#define	MSFC_HBAPortAttributesResults_PortSupportedFc4Types_ID 7

	//
	UCHAR PortActiveFc4Types[32];
#define	MSFC_HBAPortAttributesResults_PortActiveFc4Types_SIZE \
	sizeof (UCHAR[32])
...
#define	MSFC_HBAPortAttributesResults_NumberofDiscoveredPorts_SIZE \
	sizeof (ULONG)
...
#define	MSFC_HBAPortAttributesResults_SIZE \
	(FIELD_OFFSET(MSFC_HBAPortAttributesResults, NumberofDiscoveredPorts) +\
	MSFC_HBAPortAttributesResults_NumberofDiscoveredPorts_SIZE)

// MSFC_FibrePortHBAAttributes - MSFC_FibrePortHBAAttributes
#define	MSFC_FibrePortHBAAttributesGuid \
	{ 0x61b397fd, 0xf5ae, 0x4950, { 0x97, 0x58, 0x0e, 0xe5, 0x98,\
	0xe3, 0xc6, 0xe6 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSFC_FibrePortHBAAttributes_GUID, \
    0x61b397fd, 0xf5ae, 0x4950, 0x97, 0x58, 0x0e, 0xe5,\
    0x98, 0xe3, 0xc6, 0xe6);
#endif
...
#define	MSFC_FibrePortHBAAttributes_Attributes_SIZE \
...
#define	MSFC_FibrePortHBAAttributes_SIZE \
	(FIELD_OFFSET(MSFC_FibrePortHBAAttributes, Attributes) + \
	MSFC_FibrePortHBAAttributes_Attributes_SIZE)

// MSFC_FibrePortHBAStatistics - MSFC_FibrePortHBAStatistics
#define	MSFC_FibrePortHBAStatisticsGuid \
	{ 0x27efaba4, 0x362a, 0x4f20, \
	{ 0x92, 0x0b, 0xed, 0x66, 0xe2, 0x80, 0xfc, 0xf5 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSFC_FibrePortHBAStatistics_GUID, \
    0x27efaba4, 0x362a, 0x4f20, 0x92, 0x0b, 0xed, 0x66,\
    0xe2, 0x80, 0xfc, 0xf5);
#endif
...
#define	MSFC_FibrePortHBAStatistics_Statistics_SIZE \
...
#define	MSFC_FibrePortHBAStatistics_SIZE \
	(FIELD_OFFSET(MSFC_FibrePortHBAStatistics, Statistics) + \
	MSFC_FibrePortHBAStatistics_Statistics_SIZE)

// MSFC_FibrePortHBAMethods - MSFC_FibrePortHBAMethods
#define	MSFC_FibrePortHBAMethodsGuid \
	{ 0xe693553e, 0xedf6, 0x4d57, \
	{ 0xbf, 0x08, 0xef, 0xca, 0xae, 0x1a, 0x2e, 0x1c } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSFC_FibrePortHBAMethods_GUID, \
    0xe693553e, 0xedf6, 0x4d57, 0xbf, 0x08, 0xef, 0xca, \
    0xae, 0x1a, 0x2e, 0x1c);
#endif
...
#define	MSFC_FC4STATISTICSGuid \
	{ 0xca8e7fe6, 0xb85e, 0x497f, \
	{ 0x88, 0x58, 0x9b, 0x5d, 0x93, 0xa6, 0x6f, 0xe1 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSFC_FC4STATISTICS_GUID, \
    0xca8e7fe6, 0xb85e, 0x497f, 0x88, 0x58, 0x9b, 0x5d, \
    0x93, 0xa6, 0x6f, 0xe1);
#endif
...
#define	MSFC_FC4STATISTICS_SIZE \
	(FIELD_OFFSET(MSFC_FC4STATISTICS, OutputMegabytes) +\
	MSFC_FC4STATISTICS_OutputMegabytes_SIZE)

// MSFC_EventBuffer - MSFC_EventBuffer
#define	MSFC_EventBufferGuid \
	{ 0x623f4588, 0xcf01, 0x4f0e, \
	{ 0xb1, 0x97, 0xab, 0xbe, 0xe5, 0xe0, 0xcf, 0xf3 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSFC_EventBuffer_GUID, \
    0x623f4588, 0xcf01, 0x4f0e, 0xb1, 0x97, 0xab, 0xbe, \
    0xe5, 0xe0, 0xcf, 0xf3);
#endif
...
#define	MSFC_EventBuffer_SIZE \
	(FIELD_OFFSET(MSFC_EventBuffer, EventInfo) + \
	MSFC_EventBuffer_EventInfo_SIZE)

// MSFC_HBAAdapterMethods - MSFC_HBAAdapterMethods
#define	MSFC_HBAAdapterMethodsGuid \
	{ 0xdf87d4ed, 0x4612, 0x4d12, \
	{ 0x85, 0xfb, 0x83, 0x57, 0x4e, 0xc3, 0x4b, 0x7c } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSFC_HBAAdapterMethods_GUID, \
    0xdf87d4ed, 0x4612, 0x4d12, 0x85, 0xfb, 0x83, 0x57, \
    0x4e, 0xc3, 0x4b, 0x7c);
#endif
...
#define	GetDiscoveredPortAttributes_IN_SIZE \
	(FIELD_OFFSET(GetDiscoveredPortAttributes_IN, DiscoveredPortIndex) +\
	GetDiscoveredPortAttributes_IN_DiscoveredPortIndex_SIZE)
...
#define	GetDiscoveredPortAttributes_OUT_PortAttributes_SIZE \
	sizeof (MSFC_HBAPortAttributesResults)
...
#define	GetDiscoveredPortAttributes_OUT_SIZE \
	(FIELD_OFFSET(GetDiscoveredPortAttributes_OUT, PortAttributes) + \
	GetDiscoveredPortAttributes_OUT_PortAttributes_SIZE)
...
#define	GetPortAttributesByWWN_IN_SIZE \
	(FIELD_OFFSET(GetPortAttributesByWWN_IN, wwn) + \
	GetPortAttributesByWWN_IN_wwn_SIZE)
...
#define	GetPortAttributesByWWN_OUT_HBAStatus_ID 2
	...
	//
    MSFC_HBAPortAttributesResults PortAttributes;
#define	GetPortAttributesByWWN_OUT_PortAttributes_SIZE \
	sizeof (MSFC_HBAPortAttributesResults)
#define	GetPortAttributesByWWN_OUT_PortAttributes_ID 3

} GetPortAttributesByWWN_OUT, *PGetPortAttributesByWWN_OUT;

#define	GetPortAttributesByWWN_OUT_SIZE \
	(FIELD_OFFSET(GetPortAttributesByWWN_OUT, PortAttributes) +\
	GetPortAttributesByWWN_OUT_PortAttributes_SIZE)
...
#define	SendRNID_IN_SIZE \
	(FIELD_OFFSET(SendRNID_IN, wwntype) + SendRNID_IN_wwntype_SIZE)
...
#define	SendRNIDV2_IN_SIZE \
	(FIELD_OFFSET(SendRNIDV2_IN, NodeIdDataFormat) + \
	SendRNIDV2_IN_NodeIdDataFormat_SIZE)
...
#define	GetFC3MgmtInfo_OUT_SIZE \
	(FIELD_OFFSET(GetFC3MgmtInfo_OUT, MgmtInfo) + \
	GetFC3MgmtInfo_OUT_MgmtInfo_SIZE)
...
#define	SetFC3MgmtInfo_IN_SIZE \
	(FIELD_OFFSET(SetFC3MgmtInfo_IN, MgmtInfo) + \
	SetFC3MgmtInfo_IN_MgmtInfo_SIZE)
...
#define	SetFC3MgmtInfo_OUT_SIZE \
	(FIELD_OFFSET(SetFC3MgmtInfo_OUT, HBAStatus) + \
	SetFC3MgmtInfo_OUT_HBAStatus_SIZE)
...
#define	SendRPL_IN_SIZE \
	(FIELD_OFFSET(SendRPL_IN, portIndex) + SendRPL_IN_portIndex_SIZE)
...
#define	SendRPS_IN_SIZE \
	(FIELD_OFFSET(SendRPS_IN, ObjectPortNumber) + \
	SendRPS_IN_ObjectPortNumber_SIZE)
...
#define	SendSRL_IN_SIZE \
	(FIELD_OFFSET(SendSRL_IN, Domain) + SendSRL_IN_Domain_SIZE)
...
#define	SendLIRR_IN_SIZE \
	(FIELD_OFFSET(SendLIRR_IN, Type) + SendLIRR_IN_Type_SIZE)
...
#define	GetFC4Statistics_IN_SIZE \
	(FIELD_OFFSET(GetFC4Statistics_IN, FC4Type) + \
	GetFC4Statistics_IN_FC4Type_SIZE)
...
#define	GetFC4Statistics_OUT_SIZE \
	(FIELD_OFFSET(GetFC4Statistics_OUT, FC4Statistics) + \
	GetFC4Statistics_OUT_FC4Statistics_SIZE)
...
#define	GetFCPStatistics_IN_SIZE \
	(FIELD_OFFSET(GetFCPStatistics_IN, ScsiId) + \
	GetFCPStatistics_IN_ScsiId_SIZE)
...
#define	GetFCPStatistics_OUT_SIZE \
	(FIELD_OFFSET(GetFCPStatistics_OUT, FC4Statistics) + \
	GetFCPStatistics_OUT_FC4Statistics_SIZE)
...
#define	ScsiInquiry_IN_SIZE \
	(FIELD_OFFSET(ScsiInquiry_IN, FcLun) + ScsiInquiry_IN_FcLun_SIZE)
...
#define	ScsiReadCapacity_IN_SIZE \
	(FIELD_OFFSET(ScsiReadCapacity_IN, FcLun) + \
	ScsiReadCapacity_IN_FcLun_SIZE)
...
#define	ScsiReportLuns_IN_SIZE \
	(FIELD_OFFSET(ScsiReportLuns_IN, DiscoveredPortWWN) + \
	ScsiReportLuns_IN_DiscoveredPortWWN_SIZE)
...
#define	SendRLS_IN_SIZE \
	(FIELD_OFFSET(SendRLS_IN, DestWWN) + SendRLS_IN_DestWWN_SIZE)
...
// HBAFCPID - HBAFCPID
#define	HBAFCPIDGuid \
	{ 0xff02bc96, 0x7fb0, 0x4bac, \
	{ 0x8f, 0x97, 0xc7, 0x1e, 0x49, 0x5f, 0xa6, 0x98 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(HBAFCPID_GUID, \
    0xff02bc96, 0x7fb0, 0x4bac, 0x8f, 0x97, 0xc7, 0x1e, \
    0x49, 0x5f, 0xa6, 0x98);
#endif
...
#define	HBAFCPScsiEntryGuid \
	{ 0x77ca1248, 0x1505, 0x4221, \
	{ 0x8e, 0xb6, 0xbb, 0xb6, 0xec, 0x77, 0x1a, 0x87 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(HBAFCPScsiEntry_GUID, \
    0x77ca1248, 0x1505, 0x4221, 0x8e, 0xb6, 0xbb, 0xb6, \
    0xec, 0x77, 0x1a, 0x87);
#endif
...
#define	HBAFCPScsiEntry_SIZE \
	(FIELD_OFFSET(HBAFCPScsiEntry, ScsiId) + HBAFCPScsiEntry_ScsiId_SIZE)

// HBAFCPBindingEntry - HBAFCPBindingEntry
#define	HBAFCPBindingEntryGuid \
	{ 0xfceff8b7, 0x9d6b, 0x4115, \
	{ 0x84, 0x22, 0x05, 0x99, 0x24, 0x51, 0xa6, 0x29 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(HBAFCPBindingEntry_GUID, \
    0xfceff8b7, 0x9d6b, 0x4115, 0x84, 0x22, 0x05, 0x99, \
    0x24, 0x51, 0xa6, 0x29);
#endif
...
#define	HBAFCPBindingEntry_SIZE \
	(FIELD_OFFSET(HBAFCPBindingEntry, ScsiId) + \
	HBAFCPBindingEntry_ScsiId_SIZE)

// HBAFCPBindingEntry2 - HBAFCPBindingEntry2
#define	HBAFCPBindingEntry2Guid \
	{ 0x3a1e7679, 0x4b1f, 0x4f31, \
	{ 0xa8, 0xae, 0xfe, 0x92, 0x78, 0x73, 0x09, 0x24 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(HBAFCPBindingEntry2_GUID, \
    0x3a1e7679, 0x4b1f, 0x4f31, 0xa8, 0xae, 0xfe, 0x92, \
    0x78, 0x73, 0x09, 0x24);
#endif
...
#define	HBAFCPBindingEntry2_SIZE \
	(FIELD_OFFSET(HBAFCPBindingEntry2, ScsiId) + \
	HBAFCPBindingEntry2_ScsiId_SIZE)

// MSFC_HBAFCPInfo - MSFC_HBAFCPInfo
#define	MSFC_HBAFCPInfoGuid \
	{ 0x7a1fc391, 0x5b23, 0x4c19, \
	{ 0xb0, 0xeb, 0xb1, 0xae, 0xf5, 0x90, 0x50, 0xc3 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSFC_HBAFCPInfo_GUID, \
    0x7a1fc391, 0x5b23, 0x4c19, 0xb0, 0xeb, 0xb1, 0xae, \
    0xf5, 0x90, 0x50, 0xc3);
#endif
...
#define	GetFcpTargetMapping_IN_SIZE \
	(FIELD_OFFSET(GetFcpTargetMapping_IN, InEntryCount) + \
	GetFcpTargetMapping_IN_InEntryCount_SIZE)
...
#define	GetFcpPersistentBinding_IN_SIZE \
	(FIELD_OFFSET(GetFcpPersistentBinding_IN, InEntryCount) + \
	GetFcpPersistentBinding_IN_InEntryCount_SIZE)
...
#define	GetBindingCapability_IN_SIZE \
	(FIELD_OFFSET(GetBindingCapability_IN, PortWWN) + \
	GetBindingCapability_IN_PortWWN_SIZE)
...
#define	GetBindingCapability_OUT_SIZE \
	(FIELD_OFFSET(GetBindingCapability_OUT, BindType) + \
	GetBindingCapability_OUT_BindType_SIZE)
...
#define	GetBindingSupport_IN_SIZE \
	(FIELD_OFFSET(GetBindingSupport_IN, PortWWN) + \
	GetBindingSupport_IN_PortWWN_SIZE)
...
#define	GetBindingSupport_OUT_SIZE \
	(FIELD_OFFSET(GetBindingSupport_OUT, BindType) + \
	GetBindingSupport_OUT_BindType_SIZE)
...
#define	SetBindingSupport_IN_SIZE \
	(FIELD_OFFSET(SetBindingSupport_IN, BindType) + \
	SetBindingSupport_IN_BindType_SIZE)
...
#define	SetBindingSupport_OUT_SIZE \
	(FIELD_OFFSET(SetBindingSupport_OUT, HBAStatus) + \
	SetBindingSupport_OUT_HBAStatus_SIZE)
...
#define	GetPersistentBinding2_IN_SIZE \
	(FIELD_OFFSET(GetPersistentBinding2_IN, InEntryCount) + \
	GetPersistentBinding2_IN_InEntryCount_SIZE)
...
#define	HBA_REGISTRY_BINDING_RELATIVE_PATH \
	L"System\\CurrentControlSet\\Control\\Storage\\FC"
...
#define	SetPersistentEntry_IN_SIZE \
	(FIELD_OFFSET(SetPersistentEntry_IN, Binding) + \
	SetPersistentEntry_IN_Binding_SIZE)
...
#define	SetPersistentEntry_OUT_SIZE \
	(FIELD_OFFSET(SetPersistentEntry_OUT, HBAStatus) + \
	SetPersistentEntry_OUT_HBAStatus_SIZE)
...
#define	RemovePersistentEntry_IN_SIZE \
	(FIELD_OFFSET(RemovePersistentEntry_IN, Binding) + \
	RemovePersistentEntry_IN_Binding_SIZE)
...
#define	RemovePersistentEntry_OUT_SIZE \
	(FIELD_OFFSET(RemovePersistentEntry_OUT, HBAStatus) + \
	RemovePersistentEntry_OUT_HBAStatus_SIZE)


// MSFC_AdapterEvent - MSFC_AdapterEvent
#define	MSFC_AdapterEventGuid \
	{ 0xe9e47403, 0xd1d7, 0x43f8, \
	{ 0x8e, 0xe3, 0x53, 0xcd, 0xbf, 0xff, 0x56, 0x46 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSFC_AdapterEvent_GUID, \
    0xe9e47403, 0xd1d7, 0x43f8, 0x8e, 0xe3, 0x53, 0xcd, \
    0xbf, 0xff, 0x56, 0x46);
#endif
...
#define	MSFC_AdapterEvent_SIZE \
	(FIELD_OFFSET(MSFC_AdapterEvent, PortWWN) + \
	MSFC_AdapterEvent_PortWWN_SIZE)

// MSFC_PortEvent - MSFC_PortEvent
#define	MSFC_PortEventGuid \
	{ 0x095fbe97, 0x3876, 0x48ef, \
	{ 0x8a, 0x04, 0x1c, 0x55, 0x93, 0x5d, 0x0d, 0xf5 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSFC_PortEvent_GUID, \
    0x095fbe97, 0x3876, 0x48ef, 0x8a, 0x04, 0x1c, 0x55, \
    0x93, 0x5d, 0x0d, 0xf5);
#endif
...
#define	MSFC_PortEvent_SIZE \
	(FIELD_OFFSET(MSFC_PortEvent, PortWWN) + MSFC_PortEvent_PortWWN_SIZE)

// MSFC_TargetEvent - MSFC_TargetEvent
#define	MSFC_TargetEventGuid \
	{ 0xcfa6ef26, 0x8675, 0x4e27, \
	{ 0x9a, 0x0b, 0xb4, 0xa8, 0x60, 0xdd, 0xd0, 0xf3 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSFC_TargetEvent_GUID, \
    0xcfa6ef26, 0x8675, 0x4e27, 0x9a, 0x0b, 0xb4, 0xa8, \
    0x60, 0xdd, 0xd0, 0xf3);
#endif
...
#define	MSFC_TargetEvent_SIZE \
	(FIELD_OFFSET(MSFC_TargetEvent, DiscoveredPortWWN) + \
	MSFC_TargetEvent_DiscoveredPortWWN_SIZE)

// MSFC_EventControl - MSFC_EventControl
#define	MSFC_EventControlGuid \
	{ 0xa251ccb3, 0x5ab0, 0x411b, \
	{ 0x87, 0x71, 0x54, 0x30, 0xef, 0x53, 0xa2, 0x6c } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSFC_EventControl_GUID, \
    0xa251ccb3, 0x5ab0, 0x411b, 0x87, 0x71, 0x54, 0x30, \
    0xef, 0x53, 0xa2, 0x6c);
#endif
...
#define	AddTarget_IN_SIZE \
	(FIELD_OFFSET(AddTarget_IN, AllTargets) + AddTarget_IN_AllTargets_SIZE)
...
#define	AddTarget_OUT_SIZE \
	(FIELD_OFFSET(AddTarget_OUT, HBAStatus) + AddTarget_OUT_HBAStatus_SIZE)
...
#define	RemoveTarget_IN_SIZE \
	(FIELD_OFFSET(RemoveTarget_IN, AllTargets) + \
	RemoveTarget_IN_AllTargets_SIZE)
...
#define	RemoveTarget_OUT_SIZE \
	(FIELD_OFFSET(RemoveTarget_OUT, HBAStatus) + \
	RemoveTarget_OUT_HBAStatus_SIZE)
...
#define	AddPort_IN_SIZE \
	(FIELD_OFFSET(AddPort_IN, PortWWN) + AddPort_IN_PortWWN_SIZE)
...
#define	AddPort_OUT_SIZE \
	(FIELD_OFFSET(AddPort_OUT, HBAStatus) + AddPort_OUT_HBAStatus_SIZE)
...
#define	RemovePort_IN_SIZE \
	(FIELD_OFFSET(RemovePort_IN, PortWWN) + RemovePort_IN_PortWWN_SIZE)
...
#define	RemovePort_OUT_SIZE \
	(FIELD_OFFSET(RemovePort_OUT, HBAStatus) + \
	RemovePort_OUT_HBAStatus_SIZE)
...
#define	AddLink_OUT_SIZE \
	(FIELD_OFFSET(AddLink_OUT, HBAStatus) + AddLink_OUT_HBAStatus_SIZE)
...
#define	RemoveLink_OUT_SIZE \
	(FIELD_OFFSET(RemoveLink_OUT, HBAStatus) + \
	RemoveLink_OUT_HBAStatus_SIZE)
...
#define	MS_SM_AdapterInformationQueryGuid \
	{ 0xbdc67efa, 0xe5e7, 0x4777, \
	{ 0xb1, 0x3c, 0x62, 0x14, 0x59, 0x65, 0x70, 0x99 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SM_AdapterInformationQuery_GUID, \
    0xbdc67efa, 0xe5e7, 0x4777, 0xb1, 0x3c, 0x62, 0x14, \
    0x59, 0x65, 0x70, 0x99);
#endif
...
#define	MS_SMHBA_FC_PortGuid \
	{ 0x96b827a7, 0x2b4a, 0x49c8, \
	{ 0x90, 0x97, 0x07, 0x82, 0x00, 0xc5, 0xa5, 0xcd } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SMHBA_FC_Port_GUID, \
    0x96b827a7, 0x2b4a, 0x49c8, 0x90, 0x97, 0x07, 0x82, \
    0x00, 0xc5, 0xa5, 0xcd);
#endif
...
#define	MS_SMHBA_SAS_PortGuid \
	{ 0xb914e34f, 0x7b80, 0x46b0, \
	{ 0x80, 0x34, 0x6d, 0x9b, 0x68, 0x9e, 0x1d, 0xdd } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SMHBA_SAS_Port_GUID, \
    0xb914e34f, 0x7b80, 0x46b0, 0x80, 0x34, 0x6d, 0x9b, \
    0x68, 0x9e, 0x1d, 0xdd);
#endif
...
#define	MS_SMHBA_SAS_Port_SIZE \
	(FIELD_OFFSET(MS_SMHBA_SAS_Port, NumberofPhys) + \
	MS_SMHBA_SAS_Port_NumberofPhys_SIZE)

// MS_SMHBA_PORTATTRIBUTES - MS_SMHBA_PORTATTRIBUTES
#define	MS_SMHBA_PORTATTRIBUTESGuid \
	{ 0x50a97b2d, 0x99ad, 0x4cf9, \
	{ 0x84, 0x37, 0xb4, 0xea, 0x0c, 0x07, 0xbe, 0x4c } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SMHBA_PORTATTRIBUTES_GUID, \
    0x50a97b2d, 0x99ad, 0x4cf9, 0x84, 0x37, 0xb4, 0xea, \
    0x0c, 0x07, 0xbe, 0x4c);
#endif
...
#define	MS_SMHBA_PROTOCOLSTATISTICSGuid \
	{ 0xb557bd86, 0x4128, 0x4d5c, \
	{ 0xb6, 0xe6, 0xb6, 0x5f, 0x9b, 0xd6, 0x87, 0x22 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SMHBA_PROTOCOLSTATISTICS_GUID, \
    0xb557bd86, 0x4128, 0x4d5c, 0xb6, 0xe6, 0xb6, 0x5f, \
    0x9b, 0xd6, 0x87, 0x22);
#endif
...
#define	MS_SMHBA_PROTOCOLSTATISTICS_SIZE \
	(FIELD_OFFSET(MS_SMHBA_PROTOCOLSTATISTICS, OutputMegabytes) + \
	MS_SMHBA_PROTOCOLSTATISTICS_OutputMegabytes_SIZE)

// MS_SMHBA_SASPHYSTATISTICS - MS_SMHBA_SASPHYSTATISTICS
#define	MS_SMHBA_SASPHYSTATISTICSGuid \
	{ 0xbd458e7d, 0xc40a, 0x4401, \
	{ 0xa1, 0x79, 0x11, 0x91, 0x9c, 0xbc, 0xc5, 0xc6 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SMHBA_SASPHYSTATISTICS_GUID, \
    0xbd458e7d, 0xc40a, 0x4401, 0xa1, 0x79, 0x11, 0x91, \
    0x9c, 0xbc, 0xc5, 0xc6);
#endif
...
#define	MS_SMHBA_SASPHYSTATISTICS_SIZE \
	(FIELD_OFFSET(MS_SMHBA_SASPHYSTATISTICS, PhyResetProblemCount) + \
	MS_SMHBA_SASPHYSTATISTICS_PhyResetProblemCount_SIZE)

// MS_SMHBA_FC_PHY - MS_SMHBA_FC_PHY
#define	MS_SMHBA_FC_PHYGuid \
	{ 0xfb66c8fe, 0x1da0, 0x48a2, \
	{ 0x92, 0xdb, 0x02, 0xc3, 0x41, 0x14, 0x3c, 0x46 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SMHBA_FC_PHY_GUID, \
    0xfb66c8fe, 0x1da0, 0x48a2, 0x92, 0xdb, 0x02, 0xc3, \
    0x41, 0x14, 0x3c, 0x46);
#endif
...
#define	MS_SMHBA_FC_PHY_SIZE \
	(FIELD_OFFSET(MS_SMHBA_FC_PHY, MaxFrameSize) + \
	MS_SMHBA_FC_PHY_MaxFrameSize_SIZE)

// MS_SMHBA_SAS_PHY - MS_SMHBA_SAS_PHY
#define	MS_SMHBA_SAS_PHYGuid \
	{ 0xdde0a090, 0x96bc, 0x452b, \
	{ 0x9a, 0x64, 0x6f, 0xbb, 0x6a, 0x19, 0xc4, 0x7d } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SMHBA_SAS_PHY_GUID, \
    0xdde0a090, 0x96bc, 0x452b, 0x9a, 0x64, 0x6f, 0xbb, \
    0x6a, 0x19, 0xc4, 0x7d);
#endif
...
#define	MS_SMHBA_SAS_PHY_SIZE \
	(FIELD_OFFSET(MS_SMHBA_SAS_PHY, domainPortWWN) + \
	MS_SMHBA_SAS_PHY_domainPortWWN_SIZE)

// MS_SM_PortInformationMethods - MS_SM_PortInformationMethods
#define	MS_SM_PortInformationMethodsGuid \
	{ 0x5b6a8b86, 0x708d, 0x4ec6, \
	{ 0x82, 0xa6, 0x39, 0xad, 0xcf, 0x6f, 0x64, 0x33 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SM_PortInformationMethods_GUID, \
    0x5b6a8b86, 0x708d, 0x4ec6, 0x82, 0xa6, 0x39, 0xad, \
    0xcf, 0x6f, 0x64, 0x33);
#endif
...
#define	SM_GetPortType_IN_SIZE \
	(FIELD_OFFSET(SM_GetPortType_IN, PortIndex) + \
	SM_GetPortType_IN_PortIndex_SIZE)
...
#define	SM_GetPortType_OUT_SIZE \
	(FIELD_OFFSET(SM_GetPortType_OUT, PortType) + \
	SM_GetPortType_OUT_PortType_SIZE)
...
#define	SM_PORT_SPECIFIC_ATTRIBUTES_MAXSIZE \
	max(sizeof (MS_SMHBA_FC_Port),  sizeof (MS_SMHBA_SAS_Port))
	//
	ULONG PortSpecificAttributesMaxSize;
#define	SM_GetAdapterPortAttributes_IN_PortSpecificAttributesMaxSize_SIZE \
	sizeof (ULONG)
...
#define	SM_GetAdapterPortAttributes_IN_SIZE \
	(FIELD_OFFSET(SM_GetAdapterPortAttributes_IN, \
	PortSpecificAttributesMaxSize) + \
	SM_GetAdapterPortAttributes_IN_PortSpecificAttributesMaxSize_SIZE)
...
#define	SM_GetAdapterPortAttributes_OUT_SIZE \
	(FIELD_OFFSET(SM_GetAdapterPortAttributes_OUT, PortAttributes) + \
	SM_GetAdapterPortAttributes_OUT_PortAttributes_SIZE)
...
#define	SM_GetDiscoveredPortAttributes_IN_PortIndex_ID 1
	...
	//
	ULONG DiscoveredPortIndex;
#define	SM_GetDiscoveredPortAttributes_IN_DiscoveredPortIndex_SIZE \
	sizeof (ULONG)
#define	SM_GetDiscoveredPortAttributes_IN_DiscoveredPortIndex_ID 2

	//
	ULONG PortSpecificAttributesMaxSize;
#define	SM_GetDiscoveredPortAttributes_IN_PortSpecificAttributesMaxSize_SIZE \
	sizeof (ULONG)
...
#define	SM_GetDiscoveredPortAttributes_IN_SIZE \
	(FIELD_OFFSET(SM_GetDiscoveredPortAttributes_IN, \
	PortSpecificAttributesMaxSize) + \
	SM_GetDiscoveredPortAttributes_IN_PortSpecificAttributesMaxSize_SIZE)
...
#define	SM_GetDiscoveredPortAttributes_OUT_HBAStatus_ID 4
	...
	//
    MS_SMHBA_PORTATTRIBUTES PortAttributes;
#define	SM_GetDiscoveredPortAttributes_OUT_PortAttributes_SIZE \
	sizeof (MS_SMHBA_PORTATTRIBUTES)
...
#define	SM_GetDiscoveredPortAttributes_OUT_SIZE \
	(FIELD_OFFSET(SM_GetDiscoveredPortAttributes_OUT, PortAttributes) + \
	SM_GetDiscoveredPortAttributes_OUT_PortAttributes_SIZE)
...
#define	SM_GetPortAttributesByWWN_IN_DomainPortWWN_ID 2
	...
	//
	ULONG PortSpecificAttributesMaxSize;
#define	SM_GetPortAttributesByWWN_IN_PortSpecificAttributesMaxSize_SIZE \
	sizeof (ULONG)
...
#define	SM_GetPortAttributesByWWN_IN_SIZE \
	(FIELD_OFFSET(SM_GetPortAttributesByWWN_IN, \
		PortSpecificAttributesMaxSize) + \
...
#define	SM_GetPortAttributesByWWN_OUT_HBAStatus_ID 4
	...
	//
    MS_SMHBA_PORTATTRIBUTES PortAttributes;
#define	SM_GetPortAttributesByWWN_OUT_PortAttributes_SIZE \
	sizeof (MS_SMHBA_PORTATTRIBUTES)
#define	SM_GetPortAttributesByWWN_OUT_PortAttributes_ID 5

} SM_GetPortAttributesByWWN_OUT, *PSM_GetPortAttributesByWWN_OUT;

#define	SM_GetPortAttributesByWWN_OUT_SIZE \
	(FIELD_OFFSET(SM_GetPortAttributesByWWN_OUT, PortAttributes) + \
	SM_GetPortAttributesByWWN_OUT_PortAttributes_SIZE)
...
#define	SM_GetProtocolStatistics_IN_SIZE \
	(FIELD_OFFSET(SM_GetProtocolStatistics_IN, ProtocolType) + \
	SM_GetProtocolStatistics_IN_ProtocolType_SIZE)
...
#define	SM_GetProtocolStatistics_OUT_ProtocolStatistics_SIZE \
	sizeof (MS_SMHBA_PROTOCOLSTATISTICS)
#define	SM_GetProtocolStatistics_OUT_ProtocolStatistics_ID 4

} SM_GetProtocolStatistics_OUT, *PSM_GetProtocolStatistics_OUT;

#define	SM_GetProtocolStatistics_OUT_SIZE \
	(FIELD_OFFSET(SM_GetProtocolStatistics_OUT, ProtocolStatistics) + \
	SM_GetProtocolStatistics_OUT_ProtocolStatistics_SIZE)
...
#define	SM_GetPhyStatistics_IN_SIZE \
	(FIELD_OFFSET(SM_GetPhyStatistics_IN, InNumOfPhyCounters) + \
	SM_GetPhyStatistics_IN_InNumOfPhyCounters_SIZE)
...
#define	SM_GetFCPhyAttributes_IN_SIZE \
	(FIELD_OFFSET(SM_GetFCPhyAttributes_IN, PhyIndex) + \
	SM_GetFCPhyAttributes_IN_PhyIndex_SIZE)
...
#define	SM_GetFCPhyAttributes_OUT_SIZE \
	(FIELD_OFFSET(SM_GetFCPhyAttributes_OUT, PhyType) + \
	SM_GetFCPhyAttributes_OUT_PhyType_SIZE)
...
#define	SM_GetSASPhyAttributes_IN_SIZE \
	(FIELD_OFFSET(SM_GetSASPhyAttributes_IN, PhyIndex) + \
	SM_GetSASPhyAttributes_IN_PhyIndex_SIZE)
...
#define	SM_GetSASPhyAttributes_OUT_SIZE \
	(FIELD_OFFSET(SM_GetSASPhyAttributes_OUT, PhyType) + \
	SM_GetSASPhyAttributes_OUT_PhyType_SIZE)

#define	SM_RefreshInformation	10

// MS_SMHBA_PORTLUN - MS_SMHBA_PORTLUN
#define	MS_SMHBA_PORTLUNGuid \
	{ 0x0669d100, 0x066e, 0x4e49, \
	{ 0xa6, 0x8c, 0xe0, 0x51, 0x99, 0x59, 0x61, 0x32 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SMHBA_PORTLUN_GUID, \
    0x0669d100, 0x066e, 0x4e49, 0xa6, 0x8c, 0xe0, 0x51, \
    0x99, 0x59, 0x61, 0x32);
#endif
...
#define	MS_SMHBA_PORTLUN_SIZE \
	(FIELD_OFFSET(MS_SMHBA_PORTLUN, TargetLun) + \
	MS_SMHBA_PORTLUN_TargetLun_SIZE)

// MS_SMHBA_SCSIENTRY - MS_SMHBA_SCSIENTRY
#define	MS_SMHBA_SCSIENTRYGuid \
	{ 0x125d41bc, 0x7643, 0x4155, \
	{ 0xb8, 0x1c, 0xe2, 0xf1, 0x28, 0xad, 0x1f, 0xb4 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SMHBA_SCSIENTRY_GUID, \
    0x125d41bc, 0x7643, 0x4155, 0xb8, 0x1c, 0xe2, 0xf1, \
    0x28, 0xad, 0x1f, 0xb4);
#endif
...
#define	MS_SMHBA_SCSIENTRY_SIZE \
	(FIELD_OFFSET(MS_SMHBA_SCSIENTRY, ScsiId) + \
	MS_SMHBA_SCSIENTRY_ScsiId_SIZE)

// MS_SMHBA_BINDINGENTRY - MS_SMHBA_BINDINGENTRY
#define	MS_SMHBA_BINDINGENTRYGuid \
	{ 0x65bfb548, 0xd00a, 0x4d4c, \
	{ 0xa3, 0x57, 0x7d, 0xaa, 0x23, 0xbc, 0x2e, 0x3d } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SMHBA_BINDINGENTRY_GUID, \
    0x65bfb548, 0xd00a, 0x4d4c, 0xa3, 0x57, 0x7d, 0xaa, \
    0x23, 0xbc, 0x2e, 0x3d);
#endif
...
#define	MS_SMHBA_BINDINGENTRY_SIZE \
	(FIELD_OFFSET(MS_SMHBA_BINDINGENTRY, ScsiId) + \
	MS_SMHBA_BINDINGENTRY_ScsiId_SIZE)

// MS_SM_TargetInformationMethods - MS_SM_TargetInformationMethods
#define	MS_SM_TargetInformationMethodsGuid \
	{ 0x93545055, 0xab4c, 0x4e80, \
	{ 0x84, 0xae, 0x6a, 0x86, 0xa2, 0xdc, 0x4b, 0x84 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SM_TargetInformationMethods_GUID, \
    0x93545055, 0xab4c, 0x4e80, 0x84, 0xae, 0x6a, 0x86, \
    0xa2, 0xdc, 0x4b, 0x84);
#endif
...
#define	SM_GetTargetMapping_IN_SIZE \
	(FIELD_OFFSET(SM_GetTargetMapping_IN, InEntryCount) + \
	SM_GetTargetMapping_IN_InEntryCount_SIZE)
...
#define	SM_GetBindingCapability_IN_SIZE \
	(FIELD_OFFSET(SM_GetBindingCapability_IN, DomainPortWWN) + \
	SM_GetBindingCapability_IN_DomainPortWWN_SIZE)
...
#define	SM_GetBindingCapability_OUT_SIZE \
	(FIELD_OFFSET(SM_GetBindingCapability_OUT, Flags) + \
	SM_GetBindingCapability_OUT_Flags_SIZE)
...
#define	SM_GetBindingSupport_IN_SIZE \
	(FIELD_OFFSET(SM_GetBindingSupport_IN, DomainPortWWN) + \
	SM_GetBindingSupport_IN_DomainPortWWN_SIZE)
...
#define	SM_GetBindingSupport_OUT_SIZE \
	(FIELD_OFFSET(SM_GetBindingSupport_OUT, Flags) + \
	SM_GetBindingSupport_OUT_Flags_SIZE)
...
#define	SM_SetBindingSupport_IN_SIZE \
	(FIELD_OFFSET(SM_SetBindingSupport_IN, Flags) + \
	SM_SetBindingSupport_IN_Flags_SIZE)
...
#define	SM_SetBindingSupport_OUT_SIZE \
	(FIELD_OFFSET(SM_SetBindingSupport_OUT, HBAStatus) + \
	SM_SetBindingSupport_OUT_HBAStatus_SIZE)
...
#define	SM_GetPersistentBinding_IN_SIZE \
	(FIELD_OFFSET(SM_GetPersistentBinding_IN, InEntryCount) + \
	SM_GetPersistentBinding_IN_InEntryCount_SIZE)
...
#define	SM_RemovePersistentBinding_OUT_SIZE \
	(FIELD_OFFSET(SM_RemovePersistentBinding_OUT, HBAStatus) + \
	SM_RemovePersistentBinding_OUT_HBAStatus_SIZE)
...
#define	SM_GetLUNStatistics_IN_SIZE \
	(FIELD_OFFSET(SM_GetLUNStatistics_IN, Lunit) + \
	SM_GetLUNStatistics_IN_Lunit_SIZE)
...
#define	SM_GetLUNStatistics_OUT_HBAStatus_ID 2
	...
	//
    MS_SMHBA_PROTOCOLSTATISTICS ProtocolStatistics;
#define	SM_GetLUNStatistics_OUT_ProtocolStatistics_SIZE \
	sizeof (MS_SMHBA_PROTOCOLSTATISTICS)
#define	SM_GetLUNStatistics_OUT_ProtocolStatistics_ID 3

} SM_GetLUNStatistics_OUT, *PSM_GetLUNStatistics_OUT;

#define	SM_GetLUNStatistics_OUT_SIZE \
	(FIELD_OFFSET(SM_GetLUNStatistics_OUT, ProtocolStatistics) + \
	SM_GetLUNStatistics_OUT_ProtocolStatistics_SIZE)


// MS_SM_ScsiInformationMethods - MS_SM_ScsiInformationMethods
#define	MS_SM_ScsiInformationMethodsGuid \
	{ 0xb6661e6f, 0x075e, 0x4209, \
	{ 0xae, 0x20, 0xfe, 0x81, 0xdb, 0x03, 0xd9, 0x79 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SM_ScsiInformationMethods_GUID, \
    0xb6661e6f, 0x075e, 0x4209, 0xae, 0x20, 0xfe, 0x81, \
    0xdb, 0x03, 0xd9, 0x79);
#endif
...
#define	SM_ScsiInquiry_IN_SIZE \
	(FIELD_OFFSET(SM_ScsiInquiry_IN, InSenseBufferMaxSize) + \
	SM_ScsiInquiry_IN_InSenseBufferMaxSize_SIZE)
...
#define	SM_ScsiReportLuns_IN_SIZE \
	(FIELD_OFFSET(SM_ScsiReportLuns_IN, InSenseBufferMaxSize) + \
	SM_ScsiReportLuns_IN_InSenseBufferMaxSize_SIZE)
...
#define	SM_ScsiReadCapacity_IN_SIZE \
	(FIELD_OFFSET(SM_ScsiReadCapacity_IN, InSenseBufferMaxSize) + \
	SM_ScsiReadCapacity_IN_InSenseBufferMaxSize_SIZE)
...
#define	MS_SM_FabricAndDomainManagementMethodsGuid \
	...
	{ 0x91, 0x7f, 0x73, 0x06, 0x20, 0xce, 0xa3, 0x28 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SM_FabricAndDomainManagementMethods_GUID, \
    0x467fea10, 0x701b, 0x4388, 0x91, 0x7f, 0x73, 0x06, \
    0x20, 0xce, 0xa3, 0x28);
#endif
...
#define	SM_SendTEST_OUT_SIZE \
	(FIELD_OFFSET(SM_SendTEST_OUT, HBAStatus) + \
	SM_SendTEST_OUT_HBAStatus_SIZE)
...
#define	SM_GetRNIDMgmtInfo_OUT_SIZE \
	(FIELD_OFFSET(SM_GetRNIDMgmtInfo_OUT, MgmtInfo) + \
	SM_GetRNIDMgmtInfo_OUT_MgmtInfo_SIZE)
...
#define	SM_SetRNIDMgmtInfo_IN_SIZE \
	(FIELD_OFFSET(SM_SetRNIDMgmtInfo_IN, MgmtInfo) + \
	SM_SetRNIDMgmtInfo_IN_MgmtInfo_SIZE)
...
#define	SM_SetRNIDMgmtInfo_OUT_SIZE \
	(FIELD_OFFSET(SM_SetRNIDMgmtInfo_OUT, HBAStatus) + \
	SM_SetRNIDMgmtInfo_OUT_HBAStatus_SIZE)
...
#define	SM_SendRNID_IN_SIZE \
	(FIELD_OFFSET(SM_SendRNID_IN, InRespBufferMaxSize) + \
...
#define	SM_SendRPL_IN_SIZE \
	(FIELD_OFFSET(SM_SendRPL_IN, InRespBufferMaxSize) + \
	SM_SendRPL_IN_InRespBufferMaxSize_SIZE)
...
#define	SM_SendRPS_IN_SIZE \
	(FIELD_OFFSET(SM_SendRPS_IN, InRespBufferMaxSize) + \
	SM_SendRPS_IN_InRespBufferMaxSize_SIZE)
...
#define	SM_SendSRL_IN_SIZE \
	(FIELD_OFFSET(SM_SendSRL_IN, InRespBufferMaxSize) + \
	SM_SendSRL_IN_InRespBufferMaxSize_SIZE)
...
#define	SM_SendLIRR_IN_SIZE \
	(FIELD_OFFSET(SM_SendLIRR_IN, InRespBufferMaxSize) + \
	SM_SendLIRR_IN_InRespBufferMaxSize_SIZE)
...
#define	SM_SendRLS_IN_SIZE \
	(FIELD_OFFSET(SM_SendRLS_IN, InRespBufferMaxSize) + \
	SM_SendRLS_IN_InRespBufferMaxSize_SIZE)
...
#define	MS_SM_AdapterEventGuid \
	{ 0x7944cf67, 0x697b, 0x4432, \
	{ 0x95, 0x3e, 0x1f, 0xda, 0xda, 0x88, 0x43, 0x61 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SM_AdapterEvent_GUID, \
    0x7944cf67, 0x697b, 0x4432, 0x95, 0x3e, 0x1f, 0xda, \
    0xda, 0x88, 0x43, 0x61);
#endif
...
#define	MS_SM_AdapterEvent_SIZE \
	(FIELD_OFFSET(MS_SM_AdapterEvent, PortWWN) + \
	MS_SM_AdapterEvent_PortWWN_SIZE)

// MS_SM_PortEvent - MS_SM_PortEvent
#define	MS_SM_PortEventGuid \
	{ 0x0f760256, 0x8fc6, 0x47ad, \
	{ 0x9d, 0x2e, 0xf0, 0xd6, 0x98, 0x01, 0xde, 0x7c } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SM_PortEvent_GUID, \
    0x0f760256, 0x8fc6, 0x47ad, 0x9d, 0x2e, 0xf0, 0xd6, \
    0x98, 0x01, 0xde, 0x7c);
#endif
...
#define	MS_SM_PortEvent_SIZE \
	(FIELD_OFFSET(MS_SM_PortEvent, PortWWN) + MS_SM_PortEvent_PortWWN_SIZE)

// MS_SM_TargetEvent - MS_SM_TargetEvent
#define	MS_SM_TargetEventGuid \
	{ 0x6e2d8b73, 0xf928, 0x4da9, \
	{ 0xbd, 0xa1, 0xae, 0x54, 0x18, 0x9a, 0x38, 0x25 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SM_TargetEvent_GUID, \
    0x6e2d8b73, 0xf928, 0x4da9, 0xbd, 0xa1, 0xae, 0x54, \
    0x18, 0x9a, 0x38, 0x25);
#endif
...
#define	MS_SM_TargetEvent_SIZE \
	(FIELD_OFFSET(MS_SM_TargetEvent, DomainPortWWN) + \
	MS_SM_TargetEvent_DomainPortWWN_SIZE)

// MS_SM_EventControl - MS_SM_EventControl
#define	MS_SM_EventControlGuid \
	{ 0xd6145693, 0x5988, 0x457f, \
	{ 0x85, 0x81, 0x9a, 0x01, 0x57, 0xb5, 0x86, 0x90 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MS_SM_EventControl_GUID, \
    0xd6145693, 0x5988, 0x457f, 0x85, 0x81, 0x9a, 0x01, \
    0x57, 0xb5, 0x86, 0x90);
#endif
...
#define	SM_AddTarget_IN_SIZE \
	(FIELD_OFFSET(SM_AddTarget_IN, AllTargets) + \
	SM_AddTarget_IN_AllTargets_SIZE)
...
#define	SM_AddTarget_OUT_SIZE \
	(FIELD_OFFSET(SM_AddTarget_OUT, HBAStatus) + \
	SM_AddTarget_OUT_HBAStatus_SIZE)
...
#define	SM_RemoveTarget_IN_SIZE \
	(FIELD_OFFSET(SM_RemoveTarget_IN, AllTargets) + \
	SM_RemoveTarget_IN_AllTargets_SIZE)
...
#define	SM_RemoveTarget_OUT_SIZE \
	(FIELD_OFFSET(SM_RemoveTarget_OUT, HBAStatus) + \
	SM_RemoveTarget_OUT_HBAStatus_SIZE)
...
#define	SM_AddPort_IN_SIZE \
	(FIELD_OFFSET(SM_AddPort_IN, EventType) + SM_AddPort_IN_EventType_SIZE)
...
#define	SM_AddPort_OUT_SIZE \
	(FIELD_OFFSET(SM_AddPort_OUT, HBAStatus) + \
	SM_AddPort_OUT_HBAStatus_SIZE)
...
#define	SM_RemovePort_IN_SIZE \
	(FIELD_OFFSET(SM_RemovePort_IN, EventType) + \
	SM_RemovePort_IN_EventType_SIZE)
...
#define	SM_RemovePort_OUT_SIZE \
	(FIELD_OFFSET(SM_RemovePort_OUT, HBAStatus) + \
	SM_RemovePort_OUT_HBAStatus_SIZE)
...
#define	SM_AddLink_OUT_SIZE \
	(FIELD_OFFSET(SM_AddLink_OUT, HBAStatus) + \
	SM_AddLink_OUT_HBAStatus_SIZE)
...
#define	SM_RemoveLink_OUT_SIZE \
	(FIELD_OFFSET(SM_RemoveLink_OUT, HBAStatus) + \
	SM_RemoveLink_OUT_HBAStatus_SIZE)
...
#define	MSFC_TMGuid \
	{ 0x8cf4c7eb, 0xa286, 0x409d, \
	{ 0x9e, 0xb9, 0x29, 0xd7, 0xe0, 0xe9, 0xf4, 0xfa } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(MSFC_TM_GUID, \
    0x8cf4c7eb, 0xa286, 0x409d, 0x9e, 0xb9, 0x29, 0xd7, \
    0xe0, 0xe9, 0xf4, 0xfa);
#endif
...
#define	GmDemoDriverGuid \
	{ 0x33168f61, 0x67a8, 0x408e, \
	{ 0xb2, 0x62, 0x12, 0x40, 0xaa, 0xc0, 0x34, 0x47 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(GmDemoDriver_GUID, \
    0x33168f61, 0x67a8, 0x408e, 0xb2, 0x62, 0x12, 0x40,\
    0xaa, 0xc0, 0x34, 0x47);
#endif
...
#define	GmDemoDriver_SIZE \
	(FIELD_OFFSET(GmDemoDriver, WMISRBsSeen) + \
	GmDemoDriver_WMISRBsSeen_SIZE)

// GmDemoDriver2 - GmDemoDriver2
// GmDemoDriver Schema2
#define	GmDemoDriver2Guid \
	{ 0x33168f62, 0x67a8, 0x408e, \
	{ 0xb2, 0x62, 0x12, 0x40, 0xaa, 0xc0, 0x34, 0x47 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(GmDemoDriver2_GUID, \
    0x33168f62, 0x67a8, 0x408e, 0xb2, 0x62, 0x12, 0x40, \
    0xaa, 0xc0, 0x34, 0x47);
#endif
...
#define	GmDemoDriverSrbActivityGuid \
	{ 0x33168f63, 0x67a8, 0x408e, \
	{ 0xb2, 0x62, 0x12, 0x40, 0xaa, 0xc0, 0x34, 0x47 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(GmDemoDriverSrbActivity_GUID, \
    0x33168f63, 0x67a8, 0x408e, 0xb2, 0x62, 0x12, 0x40, \
    0xaa, 0xc0, 0x34, 0x47);
#endif
...
#define	GmDemoDriverSrbActivity_SIZE \
	(FIELD_OFFSET(GmDemoDriverSrbActivity, TotalIoCtlSrbs) + \
	GmDemoDriverSrbActivity_TotalIoCtlSrbs_SIZE)

// GmDrvDrvMethod - GmDrvDrvMethod
// WMI method
#define	GmDrvDrvMethodGuid \
	{ 0x33168f64, 0x67a8, 0x408e, \
	{ 0xb2, 0x62, 0x12, 0x40, 0xaa, 0xc0, 0x34, 0x47 } }

#if ! (defined(MIDL_PASS))
DEFINE_GUID(GmDrvDrvMethod_GUID, \
    0x33168f64, 0x67a8, 0x408e, 0xb2, 0x62, 0x12, 0x40, \
    0xaa, 0xc0, 0x34, 0x47);
#endif
...
#define	GmDrvDemoMethod1_IN_SIZE \
	(FIELD_OFFSET(GmDrvDemoMethod1_IN, inDatum) + \
	GmDrvDemoMethod1_IN_inDatum_SIZE)
...
#define	GmDrvDemoMethod1_OUT_SIZE \
	(FIELD_OFFSET(GmDrvDemoMethod1_OUT, outDatum) + \
	GmDrvDemoMethod1_OUT_outDatum_SIZE)
...
#define	GmDrvDemoMethod2_IN_SIZE \
	(FIELD_OFFSET(GmDrvDemoMethod2_IN, inDatum2) + \
	GmDrvDemoMethod2_IN_inDatum2_SIZE)
...
#define	GmDrvDemoMethod2_OUT_SIZE \
	(FIELD_OFFSET(GmDrvDemoMethod2_OUT, outDatum1) + \
	GmDrvDemoMethod2_OUT_outDatum1_SIZE)
...
#define	GmDrvDemoMethod3_IN_SIZE \
	(FIELD_OFFSET(GmDrvDemoMethod3_IN, inDatum2) + \
	GmDrvDemoMethod3_IN_inDatum2_SIZE)
...
#define	GmDrvDemoMethod3_OUT_SIZE \
	(FIELD_OFFSET(GmDrvDemoMethod3_OUT, outDatum2) + \
	GmDrvDemoMethod3_OUT_outDatum2_SIZE)
